...
import com.shenzhou.newsclint.utils.BMapUtil;
import com.umeng.analytics.MobclickAgent;
/**
 * 用来展示如何结合定位SDK实现定位，并使用MyLocationOverlay绘制定位位置
...
public class BaiDuMapActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         */
        SHApplication app = (SHApplication)this.getApplication();
        if (app.mBMapManager == null) {
            app.mBMapManager = new BMapManager(getApplicationContext());
            /**
             * 如果BMapManager没有初始化则初始化BMapManager
             */
            app.mBMapManager.init(new SHApplication.MyGeneralListener());
        }
    ...
    public class MyLocationListenner implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            location.getProvince();//获取省份的信息
            location.getCity();
            location.getDistrict();//获取县区的信息
