...
public class ShiPinYuLeAdapter extends FragmentPagerAdapter {
	private ArrayList<Fragment> fragments = new ArrayList<Fragment>();;
	private final FragmentManager fm;

	 
	public ShiPinYuLeAdapter(FragmentManager fm) {
		super(fm);
		this.fm = fm;
	}

	public ShiPinYuLeAdapter(FragmentManager fm, ArrayList<Fragment> fragments) {
		super(fm);
